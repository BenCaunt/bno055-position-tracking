...
void loop(void)
{
  ...
  xAdjust = ACCEL_POS_TRANSITION * (linearAccelData.acceleration.x * ACCELERATION_SCALE);
  yAdjust = ACCEL_POS_TRANSITION * (linearAccelData.acceleration.y * ACCELERATION_SCALE);
